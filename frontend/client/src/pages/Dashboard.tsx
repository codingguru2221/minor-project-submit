...
export default function Dashboard() {
  ...
  const categoryData = useMemo(() => calculateCategorySpending(allTransactions, accounts), [allTransactions]);
          ...
          <div className="space-y-8">
            ...
            <div>
               ...
               <div className="bg-card rounded-3xl p-2 shadow-sm border border-border/50">
                  <TransactionList transactions={allTransactions} accounts={accounts} limit={5} />
               </div>
            </div>
          </div>
        </div>
